...
5. We use whisper to run through each of these episodes and transcribe them - saving three files for each episode:
    ...
    - SRT file - This a SubRip Subtitle file and essentially has subtitle information, including  start and end time-stamps of the text and the sequential number of subtitles.
